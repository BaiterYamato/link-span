...
M.functions = {
  ...
  ["ship.oot.audio.play_sfx"] = {
    version = "0.4.0",
    stability = "experimental",
    availability = "oot",
    capability = "oot.audio",
    arguments = {
      { name = "index", type = "integer", required = true },
      { name = "font", type = "integer", required = false },
    },
    returns = "boolean",
    error_mode = "raise",
    errors = { "invalid_argument" },
  },
  ["ship.oot.audio.dump_sfx_table"] = {
    version = "0.4.0",
    stability = "experimental",
    availability = "oot",
    capability = "oot.audio",
    arguments = {
      { name = "first", type = "integer", required = false },
  ...
  ["ship.oot.audio.set_voice_map"] = {
    version = "0.4.0",
    stability = "experimental",
    availability = "oot",
    capability = "oot.audio",
    arguments = {
      { name = "base", type = "integer", required = false },
