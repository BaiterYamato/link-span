...
probe("ship.oot.audio.play_sfx", { 1, 1 }, "boolean")
probe("ship.oot.audio.dump_sfx_table", { 1, 1, 1 }, "boolean")
probe("ship.oot.audio.set_voice_map", { 1, 1 }, "boolean")
...
mock.configure({ game = "oot", capabilities = {} })
ship_mod = mock.build()
check(resolve(ship_mod, "oot.audio.play_sfx") == nil, "ship.oot.audio.play_sfx sem capability não deveria existir")
mock.configure({ game = "oot", capabilities = {} })
ship_mod = mock.build()
check(resolve(ship_mod, "oot.audio.dump_sfx_table") == nil, "ship.oot.audio.dump_sfx_table sem capability não deveria existir")
mock.configure({ game = "oot", capabilities = {} })
ship_mod = mock.build()
check(resolve(ship_mod, "oot.audio.set_voice_map") == nil, "ship.oot.audio.set_voice_map sem capability não deveria existir")
mock.configure({ game = "oot", capabilities = {} })
ship_mod = mock.build()
